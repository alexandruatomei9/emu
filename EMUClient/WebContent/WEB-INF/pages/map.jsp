					...
					.add(
							[
									...
									"[" + latitude.toString() + ", "
											+ longitude.toString() + "]",
									country,
									'<a href="'+resourceURI+'" target="_blank">DBpedia Link</a>',
									'<a href="http://localhost:8080/EMUClient?museum='
											+ encode_utf8(resourceURI)
											+ '">See more &raquo;</a>' ])
					.draw();
		}
	}
		...
		<div class="wrapper col3">
			<center>
				...
				<div id="map-controls">
					<center>
						<p>
							Museums in a <span id="radius"
								style="border: 0; color: #f6931f; font-weight: bold;"></span>
							radius centered in <span id="radiusCenter">your current
								location</span>
						</p>
				...
				<div class="container">
					<div class="col-sm-4">
						<select id="country-select" title="Country">
							...
							<option value="Bosnia_and_Herzegovina">Bosnia and
								Herzegovina</option>
